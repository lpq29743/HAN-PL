...
def is_np(tag):
    np_list = ['NP-SBJ', 'NP', 'NP-PN-OBJ', 'NP-PN', 'NP-PN-SBJ', 'NP-OBJ', 'NP-TPC-1', 'NP-TPC', 'NP-PN-VOC', 'NP-VOC',
               'NP-IO', 'NP-SBJ-1', 'NP-PN-TPC', 'NP-PRD', 'NP-TMP', 'NP-PN-PRD', 'NP-PN-SBJ-1', 'NP-APP', 'NP-TPC-2',
               'NP-PN-SBJ-3', 'NP-PN-IO', 'NP-PN-LOC', 'NP-SBJ-2', 'NP-PN-OBJ-1', 'NP-LGS', 'NP-MNR', 'NP-SBJ-3',
               'NP-OBJ-PN', 'NP-SBJ-4', 'NP-PN-SBJ-2', 'NP-TPC-3', 'NP-HLN', 'NP-PN-APP', 'NP-SBJ-PN', 'NP-DIR',
               'NP-LOC', 'NP-ADV', 'NP-WH-SBJ']
            ...
            while True:
                ...
                if inline.startswith("Chain"):
                    ...
                    if match:
                        ...
                        if word == "*pro*":
                            if not first:
                                azps.append((sentence_index, begin_word_index, end_word_index, antecedents, coref_id, 1))
                        if not word == "*pro*":
                            first = False
